...
<body>
  <main class="container">
    ...
    <section class="split split-3-2">
      ...
      <article class="card">
        <h2>Result</h2>
        <div class="eyebrow no-gap">Predicted demand</div>
...
.card{padding:14px;border:.5px solid var(--border);border-radius:12px;background:transparent}.eyebrow{margin:10px 0 8px;color:var(--text-2);font-size:10px;font-weight:500;letter-spacing:.06em;text-transform:uppercase}.eyebrow.no-gap{margin-top:2px}
...
textarea{font-family:var(--font-mono);font-size:11px;height:110px;resize:vertical}input:focus,select:focus,textarea:focus{outline:none;border-color:var(--border-2);box-shadow:0 0 0 1px var(--border-2)}
...
.service-row{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:.5px solid var(--border)}.service-name{display:flex;align-items:center;gap:8px}.endpoint{font-family:var(--font-mono);color:var(--accent);font-size:11px}
.ev-row{display:flex;align-items:center;gap:6px;padding:4px 0}.check{color:var(--ok)}a{color:var(--text);text-decoration:none;border-bottom:.5px solid var(--border-2)}
...
const monthNames=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],weatherLabels={1:"Clear",2:"Mist",3:"Light rain",4:"Heavy"},weekdayNames=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
