...
After the image exists, it is embedded below (see also `docs/screenshots/api_predict_swagger_1.png` in the repo).

![POST /predict (Swagger)](screenshots/api_predict_swagger_1.png)
